...
int main(void)
{
    ...
    int user_status[9] = {1000, 50, 200, 270, 0, 000, 50, 1, 6};
    int itemBox[3] = {2, 2, 0};
    char *partner_name2 = " ";
    char *partner_name1 = " ";
    ...
    while (1)
    {
        ...
        {
            BossFight(user_status, &partner, &partner1Sta, &partner2Sta, partner_name1, partner_name2, itemBox, user_name);
        }
...
void chapic(int n, int user_status[], char user_name[])
{
    ...
    user_status[0] = rand() % 300 + 400;
    user_status[2] = rand() % 100 + 70;
    user_status[3] = rand() % 100 + 120;
...
void Quiz(int score, int user_status[])
{
    ...
    if (score > 0 && score < 3)
    {
        ...
        if (user_status[4] >= user_status[8])
        {
            ...
            // user_status[8]++;
            user_status[7]++;
            user_status[5] += rand() % 301 + 200;
            // user_status[6] += 10;
            user_status[2] += rand() % 51 + 50;
            user_status[3] += rand() % 101 + 100;
            user_status[0] = user_status[5];
            user_status[1] = user_status[6];
            printtext(art, 3);
            printf("레벨업!!!\n");
